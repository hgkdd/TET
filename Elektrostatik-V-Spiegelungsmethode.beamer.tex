...
\only<1-2|handout:1>{\resizebox{.8\linewidth}{!}{\input{bilder/Ladung_Spiegel}}}
    \only<2|handout:1>{\vspace{-1.8cm}
      \begin{empheq}[box=\fbox]{align}
          \DFeld{}_2\normal - \DFeld{}_1\normal &= \laddichte{F}\nonumber\\
    \EFeld{}_2\tangential - \EFeld{}_1\tangential & = 0\nonumber
  \end{empheq}}
\only<3|handout:2>{\resizebox{\linewidth}{!}{\input{bilder/gespiegelte_Ladung}}}
...
\begin{frame}
 ...
 \begin{column}{.5\linewidth}
  \resizebox{\columnwidth}{!}{\input{bilder/Kugelspiegelung}}
  \end{column}
\begin{column}{.5\linewidth}
  \begin{itemize}[<+->]
  \item Potential
...
\resizebox{\linewidth}{!}{\input{bilder/unendliche_Spiegelung}}
